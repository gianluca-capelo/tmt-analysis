...
def perform_cross_validation_for_model(param_grid, model, outer_cv, X, y, perform_pca: bool, feature_selection: bool,
    ...
    if (is_classification):
        ...
        inner_cv = KFold(n_splits=3, shuffle=True, random_state=inner_cv_seed)
    else:
    ...
    for fold, (train_idx, test_idx) in enumerate(outer_cv.split(X, y)):
        ...
        select_step = ('select', SelectKBest(score_func=f_regression, k=min(max_selected_features, X_train.shape[1]))) \
